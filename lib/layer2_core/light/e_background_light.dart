...
class EBackgroundLight {
  static DesignToken getToken(dynamic activeTheme) {
    switch (activeTheme.toString().split('.').last) {
      case 'system': return csyl1;
      case 'standard': return cstl1;
      case 'blue': return cbl1;
      case 'green': return cgl1;
      case 'red': return crl1;
      case 'nothing': return cnol1;
      default: return cstl1;
    }
  }
}
