...
class ESurfaceContainerLowDark {
  static DesignToken getToken(dynamic activeTheme) {
    switch (activeTheme.toString().split('.').last) {
      case 'system': return csyd11;
      case 'standard': return cstd11;
      case 'blue': return cbd11;
      case 'green': return cgd11;
      case 'red': return crd11;
      case 'nothing': return cnod11;
      default: return cstd11;
    }
  }
}
