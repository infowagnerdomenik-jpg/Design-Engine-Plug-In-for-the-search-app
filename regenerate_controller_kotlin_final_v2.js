...
object DesignEngineController {
    ...
    private fun resolveToken(
        ...
        val activeTheme = if (isFlutterOrder) flutterTheme else _currentTheme
        val activeThemeMode = if (isFlutterOrder) flutterThemeMode else _themeMode
        val activeAmoled = if (isFlutterOrder) flutterIsAmoled else _isAmoled
        ...
        val baseName = if (isFlutterOrder) "e" + name.drop(2) else name
...
console.log("Controller fully cleaned and regenerated.");
